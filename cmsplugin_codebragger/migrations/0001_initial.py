...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CodebraggerProjectTeaser'
        db.create_table('cmsplugin_codebraggerprojectteaser', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['codebragger.Project'])),
            ('show_subprojects', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('show_contributors', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('cmsplugin_codebragger', ['CodebraggerProjectTeaser'])

    def backwards(self, orm):
        # Deleting model 'CodebraggerProjectTeaser'
        db.delete_table('cmsplugin_codebraggerprojectteaser')
    ...
    models = {
        ...
        'cmsplugin_codebragger.codebraggerprojectteaser': {
            'Meta': {'object_name': 'CodebraggerProjectTeaser', 'db_table': "'cmsplugin_codebraggerprojectteaser'", '_ormbases': ['cms.CMSPlugin']},
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['codebragger.Project']"}),
            'show_contributors': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'show_subprojects': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'codebragger.project': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'codebragger_project_main_images'", 'null': 'True', 'to': "orm['filer.Image']"}),
    ...
    complete_apps = ['cmsplugin_codebragger']